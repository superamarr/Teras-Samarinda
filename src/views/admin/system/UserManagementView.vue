...
watch([searchQuery, filteredUsers], () => {
  currentPage.value = 1
})
...
<template>
  ...
  >
    ...
    <div v-if="filteredUsers.length > itemsPerPage" class="pagination-container d-flex justify-content-between align-items-center mt-4 px-2">
      <div class="pagination-info">
        <span class="text-secondary small">Menampilkan <strong>{{ paginatedUsers.length }}</strong> dari <strong>{{ filteredUsers.length }}</strong> data</span>
      </div>
